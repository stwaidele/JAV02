...
\subsubsection{Zufälliger Erzeuger, 3 zufällige Verbraucher} % (fold)
...
\end{scriptsize}
\end{quellcode}
% subsubsection zufalliger_erzeuger_3_zufallige_verbraucher (end)

\subsubsection{Erzeuger wartet 1 ZE, 8 zufällige Verbraucher} % (fold)
...
% subsubsection erzeuger_wartet_1_ze_8_zufallige_verbraucher (end)
% subsection erzeuger_schneller_als_verbraucher (end)

\subsection{Erzeuger langsamer als Verbraucher} % (fold)
\subsubsection{Erzeuger wartet 1 ZE, 6 zufällige Verbraucher} % (fold)
\label{ssub:zufalliger_erzeuger_3_zufallige_verbraucher}
\begin{quellcode}[H]
\begin{scriptsize}
\begin{spacing}{1.0}
...
\begin{minted}[bgcolor=bg, linenos, firstnumber=151]{java}
E (  1sek):   18 |******************  |
E (  1sek):   19 |******************* |
V3(  5sek):   20 |********************|
E (  1sek):   19 |******************* |
...
\begin{minted}[bgcolor=bg, linenos, firstnumber=225]{java}
E (  1sek):   12 |************        |
E (  1sek):   13 |*************       |
V6(  2sek):   14 |**************      |
E (  1sek):   13 |*************       |
...
\subsection{Erzeuger und Verbraucher etwa gleich schnell} % (fold)
\subsubsection{Zufälliger Erzeuger, ein zufälliger Verbraucher} % (fold)
...
\begin{minted}[bgcolor=bg, linenos, firstnumber=515]{java}
E ( 14sek):    2 |**                  |
V1(  3sek):    3 |***                 |
E (  7sek):    2 |**                  |
E (  4sek):    3 |***                 |
...
\begin{minted}[bgcolor=bg, linenos, firstnumber=3035]{java}
V1(  5sek):   18 |******************  |
E ( 12sek):   17 |*****************   |
E (  7sek):   18 |******************  |
V1( 13sek):   19 |******************* |
